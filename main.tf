...
resource "aws_ecs_cluster" "main" {
  name = "reesy-fargate-ecs-cluster"
}
...
resource "aws_ecs_service" "main" {
  name            = "reesy-fargate-ecs-service"
